...
<div class="content-wrap">
                            ...
                            <div class="bootstrap-data-table-panel">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="messsubscription" class="form-control required" type="text"
                                    ...
                                    <div class="col-md-4">
                                        <div class=" form-group">
                                            <label>SPORTS:</label>
                                            <input value="0" onkeypress="return isNumberKey(event)" id="sports" class="form-control required" type="text" name="sports"
                                    ...
                                    <div class="col-md-4">
                                        <div class=" form-group">
                                            <label>BAR:</label>
                                            <input value="0" onkeypress="return isNumberKey(event)" id="bar" class="form-control required" type="text" name="bar"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="messmaintainance" class="form-control required" type="text"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="officersinstitute" class="form-control required" type="text"
                                    ...
                                    <div class="col-md-4">
                                        <div class=" form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="partybar" class="form-control required" type="text"
                                                name="partybar" placeholder="Enter party bar">
                                            <span id="email_error_message" style="color:red"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="messservice" class="form-control required" type="text"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="ladiesclub" class="form-control required" type="text"
                                    ...
                                    <div class="col-md-4">
                                        <div class=" form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="roombearer" class="form-control required" type="text"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="dailymessing" class="form-control required" type="text"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="officerscafeteria" class="form-control required" type="text"
                                    ...
                                    <div class="col-md-4">
                                        <div class=" form-group">
                                            <label>LINEN:</label>
                                            <input value="0" onkeypress="return isNumberKey(event)" id="linen" class="form-control required" type="text" name="linen"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="extramessing" class="form-control required" type="text"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="srffund" class="form-control required" type="text" name="srffund"
                                    ...
                                    <div class="col-md-4">
                                        <div class=" form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="cleaninggear" class="form-control required" type="text"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="partymesssing" class="form-control required" type="text"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="entertainment" class="form-control required" type="text"
                                    ...
                                    <div class="col-md-4">
                                        <div class=" form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="roomrent" class="form-control required" type="text"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>GARDEN:</label>
                                            <input value="0" onkeypress="return isNumberKey(event)" id="garden" class="form-control required" type="text" name="garden"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>LIBRARY:</label>
                                            <input value="0" onkeypress="return isNumberKey(event)" id="library" class="form-control required" type="text" name="library"
                                    ...
                                    <div class="col-md-4">
                                        <div class=" form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="breakage" class="form-control required" type="text"
                                                name="breakage" placeholder="Enter breakage">
                                            <span id="email_error_message" style="color:red"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>SARANG:</label>
                                            <input value="0" onkeypress="return isNumberKey(event)" id="sarang" class="form-control required" type="text" name="sarang"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="hospitalityfund" class="form-control required" type="text"
                                    ...
                                    <div class="col-md-4">
                                        <div class=" form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="empcontingency" class="form-control required" type="text"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="socialwellbeing" class="form-control required" type="text"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>MEMENTO:</label>
                                            <input value="0" onkeypress="return isNumberKey(event)" id="memento" class="form-control required" type="text" name="memento"
                                    ...
                                    <div class="col-md-4">
                                        <div class=" form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="securitydeposit" class="form-control required" type="text"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>REFUND:</label>
                                            <input value="0" onkeypress="return isNumberKey(event)" id="refund" class="form-control required" type="text" name="refund"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>PENALTY:</label>
                                            <input value="0" onkeypress="return isNumberKey(event)" id="penalty" class="form-control required" type="text" name="penalty"
                                    ...
                                    <div class="col-md-4">
                                        <div class=" form-group">
                                            <label>ARREARS:</label>
                                            <input value="0" onkeypress="return isNumberKey(event)" id="arrears" class="form-control required" type="text" name="arrears"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="qmpacking" class="form-control required" type="text"
                                                name="qmpacking" placeholder="Enter qmpacking">
                                            <span id="name_error_message" style="color:red"></span>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="noofdays" class="form-control required" type="text"
                                                name="noofdays" placeholder="Enter no of days">
                                            <span id="name_error_message" style="color:red"></span>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="garbagecollection" class="form-control required" type="text"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="barberrecovery" class="form-control required" type="text"
                                 ...
                                 <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="amenities" class="form-control required" type="text"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="0" onkeypress="return isNumberKey(event)" id="creditdebit" class="form-control required" type="text"
    ...
    <script>
        ...
        function addMonthlybill() {
            ...
            $.ajax({
                url: " <?= LIVINGOUT_PATH ?>/addMonthlybill",
                type: "POST",
                datatype: "json",
                crossDomain: true,
                data: JSON.stringify({
