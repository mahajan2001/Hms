                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-right float-right">
                                <li><a href="<?= OFFICER_PATH ?>">Officers &nbsp; </a></li>
                                / &nbsp;
                                <li><a>Edit Officer</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card alert">
                            ...
                            <div class="bootstrap-data-table-panel">
                                <a href="<?= OFFICER_PATH ?>" class="btn btn-outline-danger float-end">BACK</a>
                                <br><br>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="contact" class="form-control required" type="text" name="contact"
                                                ...
                                                value="<?php echo $officer['contact']; ?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="ic_no" class="form-control required" type="text" name="ic_no"
                                                placeholder="Enter IC No" value="<?php echo $officer['ic_no']; ?>">
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.success == true) {
                    window.location.href = "<?= OFFICER_PATH ?>"
                } else {
