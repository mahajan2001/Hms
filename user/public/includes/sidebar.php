<div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures bg-dark">
    <div class="nano">
        <div class="nano-content bg-dark">
            <ul class="bg-dark">
                <?php /* <li class="active"><a href="<?= DASHBOARD_PATH ?>"><i class="fa-solid fa-home"></i> Dashboard </a></li>
                ...
                */ ?>
                <?php /* <li><a class="sidebar-sub-toggle"><i class="fa-solid fa-money-bill-wave"></i>Monthly Bill <br> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                ...
                <li><a href="<?= USER_PATH ?>/registration"><i class=""></i>Registration Form</a></li> 
            </ul>
        </div>
    </div>
</div><!-- /# sidebar -->
