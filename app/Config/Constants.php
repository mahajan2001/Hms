...
define('DB_USER', 'root');
define('DB_PASS', '');
define('DB_DATABASE', 'whatsapppoc');
...
//BASE Paths
define('DOMAIN_BASE_URL', $_SERVER['DOCUMENT_ROOT'] . '/WhatsappPOC/');
...
define("TBL_LIHUN_DENARE", TBL_PREFIX .  "lihun_denare");
define("TBL_LIHUN_GHENARE", TBL_PREFIX .  "lihun_ghenare");
define("TBL_MAIN_FORM", TBL_PREFIX .  "main_form");
...
define('FORM_PATH', SITE_URL . 'form/');


//Milkat Types
define('SATBARA', 1);
define('SITI_SARVESHAN', 2);
define('EIGHT_A', 3);
