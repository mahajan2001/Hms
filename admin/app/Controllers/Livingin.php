...
class Livingin extends MyController
{
    use ResponseTrait;
    ...
    public function index()
    {
        ...
        echo view('livingin/livingin', $this->dataModule);
    }
    ...
    public function add()
    {
        ...
        echo view('livingin/add', $this->dataModule);
    }
    ...
    public function edit($id)
    {
        ...
        echo view('livingin/edit', $this->dataModule);
    }
    ...
    public function printPdf($id){
        ...
        echo view('livingin/pdf', $this->dataModule);
    }
    ...
    public function downloadSampleFile()
    {
        ...
        return view('livingin/livingin', $this->dataModule);
    }
