...
class Guestbill extends MyController
{
    use ResponseTrait;
    ...
    public function index()
    {
        ...
        $this->dataModule['monthlymessdetails'] = $model->get_all_rows(TBL_MONTHLY_MESS_DETAILS . ' as mmd', 'mmd.*,m.name', array('type' => 4), $join);
        echo view('guestbill/index', $this->dataModule);
    }
    ...
    public function add()
    {
        ...
        echo view('guestbill/add', $this->dataModule);
    }
    ...
    public function edit($id)
    {
        ...
        echo view('guestbill/edit', $this->dataModule);
    }
    ...
    public function printPdf($id){
        ...
        echo view('guestbill/pdf', $this->dataModule);
    }
    ...
    public function downloadSampleFile()
    {
        ...
        return view('guestbill/index', $this->dataModule);
    }
