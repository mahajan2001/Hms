...
<div class="content-wrap">
                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-right float-right">
                                <li><a href="<?= TEMPORARYDUTY_PATH ?>">Monthly Bill &nbsp; </a></li>
                                / &nbsp;
                                <li><a>Edit Temporary duty </a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card alert">
                            ...
                            <div class="bootstrap-data-table-panel">
                                <a href="<?= TEMPORARYDUTY_PATH ?>" class="btn btn-outline-danger float-end">BACK</a>
                                <br><br>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>COURSE:</label>
                                            <input value="<?php echo $livingindetails['course']; ?>" id="course"
                                    ...
                                    <div class="col-md-6">
                                        <div class=" form-group">
                                            <label>IC CODE:</label>
                                            <input value="<?php echo $livingindetails['ic_code']; ?>" id="iccode"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>RANK:</label>
                                            <input value="<?php echo $livingindetails['rank']; ?>" id="rank"
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="name" id="name" class="form-control required">
                                                ...
                                                <?php foreach ($officers as $o) { ?>
                                                    <?php if ($o['id'] == $livingindetails['member_id']) { ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>DATE:</label>
                                            <input value="<?php echo $livingindetails['date']; ?>" id="date"
                            ...
                            <div class="bootstrap-data-table-panel">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['mess_subscription']; ?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class=" form-group">
                                            <label>SPORTS:</label>
                                            <input value="<?php echo $livingindetails['sports']; ?>" id="sports"
                                    ...
                                    <div class="col-md-4">
                                        <div class=" form-group">
                                            <label>BAR:</label>
                                            <input value="<?php echo $livingindetails['bar']; ?>" id="bar"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['mess_maintainance']; ?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['officers_institute']; ?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class=" form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['party_bar']; ?>" id="partybar"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['mess_service']; ?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['ladies_club']; ?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class=" form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['room_bearer']; ?>"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['daily_messing']; ?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['officers_cafeteria']; ?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class=" form-group">
                                            <label>LINEN:</label>
                                            <input value="<?php echo $livingindetails['linen']; ?>" id="linen"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['extra_messing']; ?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['srf_fund']; ?>" id="srffund"
                                    ...
                                    <div class="col-md-4">
                                        <div class=" form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['cleaning_gear']; ?>"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['party_messsing']; ?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['entert_ainment']; ?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class=" form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['room_rent']; ?>" id="roomrent"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>GARDEN:</label>
                                            <input value="<?php echo $livingindetails['garden']; ?>" id="garden"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>LIBRARY:</label>
                                            <input value="<?php echo $livingindetails['library']; ?>" id="library"
                                    ...
                                    <div class="col-md-4">
                                        <div class=" form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['breakage']; ?>" id="breakage"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>SARANG:</label>
                                            <input value="<?php echo $livingindetails['sarang']; ?>" id="sarang"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['hospitality_fund']; ?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class=" form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['emp_contingency']; ?>"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['social_wellbeing']; ?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>MEMENTO:</label>
                                            <input value="<?php echo $livingindetails['memento']; ?>" id="memento"
                                    ...
                                    <div class="col-md-4">
                                        <div class=" form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['security_deposit']; ?>"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>REFUND:</label>
                                            <input value="<?php echo $livingindetails['refund']; ?>" id="refund"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>PENALTY:</label>
                                            <input value="<?php echo $livingindetails['penalty']; ?>" id="penalty"
                                    ...
                                    <div class="col-md-4">
                                        <div class=" form-group">
                                            <label>ARREARS:</label>
                                            <input value="<?php echo $livingindetails['arrears']; ?>" id="arrears"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['qm_packing']; ?>" id="qmpacking"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['no_of_days']; ?>" id="noofdays"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['garbage_collection']; ?>"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['barber_recovery']; ?>"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $livingindetails['credit_debit']; ?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class=" form-group">
                                            <label>TOTAL:</label>
                                            <input value="<?php echo $livingindetails['total']; ?>" readonly id="total"
    ...
    <script>
        $(document).ready(function () {
            ...
            billofmonth.value = "<?php echo $livingindetails['bill_of_month']; ?>";
        });
        ...
        function editMonthlybill() {
            ...
            var total = $("#total").val();
            var id = <?php echo $livingindetails['id'] ?>;
            $.ajax({
                url: " <?= TEMPORARYDUTY_PATH ?>/editMonthlybill",
                type: "POST",
                datatype: "json",
                crossDomain: true,
                data: JSON.stringify({
                ...
                success: function (data) {
                    if (data.success == true) {
                        window.location.href = "<?= TEMPORARYDUTY_PATH ?>"
                    } else {
