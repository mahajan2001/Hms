...
<div class="content-wrap">
                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-right float-right">
                                <li><a href="<?= GUESTBILL_PATH ?>">Monthly Bill &nbsp; </a></li>
                                / &nbsp;
                                <li><a>Edit Guest Bill</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card alert">
                            ...
                            <div class="bootstrap-data-table-panel">
                                <a href="<?= GUESTBILL_PATH ?>" class="btn btn-outline-danger float-end">BACK</a>
                                <br><br>
    ...
    <script>
        ...
        function editMonthlybill() {
            ...
            $.ajax({
                url: " <?= GUESTBILL_PATH ?>/editMonthlybill",
                type: "POST",
                datatype: "json",
                crossDomain: true,
                data: JSON.stringify({
                ...
                success: function (data) {
                    if (data.success == true) {
                        window.location.href = "<?= GUESTBILL_PATH ?>"
                    } else {
